...
class _LogRequestWidgetState extends State<LogRequestWidget> with AutomaticKeepAliveClientMixin {
            ...
            Row(
              children: [
                ElevatedButton(
                  ...
                  child: Text('copy all', style: TextStyle(color: Colors.black)),
                ),
                SizedBox(width: 12),
                ElevatedButton(
                  onPressed: () {
                  ...
                  child: Text('copy url', style: TextStyle(color: Colors.black)),
                ),
              ],
            ),
  ...
  Widget _getDefText(String str) {
    return SelectableText(str, style: TextStyle(fontSize: 15, color: Colors.black));
  }
  ...
  Widget _buildParam(dynamic data) {
    if (data is Map) {
      ...
      try {
        ...
        return Text('body: $data', style: TextStyle(color: Colors.black));
      }
    } else {
      return SizedBox();
    }
